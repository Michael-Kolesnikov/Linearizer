...
Node* create_pointer__member_access_expression_node(Node* pointer_expression, Node* field_name) {
    PointerMemberAccessExpressionNode* node =
        (PointerMemberAccessExpressionNode*)malloc(sizeof(PointerMemberAccessExpressionNode));
...
int is_type_keyword(const char* val) {
    return strcmp(val, "int") == 0 || strcmp(val, "float") == 0 || strcmp(val, "double") == 0 ||
           strcmp(val, "char") == 0 || strcmp(val, "void") == 0 || strcmp(val, "long") == 0 ||
           strcmp(val, "short") == 0 || strcmp(val, "unsigned") == 0 || strcmp(val, "signed") == 0 ||
           strcmp(val, "struct") == 0 || strcmp(val, "union") == 0 || strcmp(val, "_Bool") == 0 ||
           strcmp(val, "_Complex") == 0 || strcmp(val, "_Imaginary") == 0 || strcmp(val, "_Noreturn") == 0;
}
