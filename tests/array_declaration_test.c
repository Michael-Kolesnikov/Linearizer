...
START_TEST(test_array_declaration_in_parameters)
{
    ...
    Node* parameter = create_declaration_node(array, create_empty_statement_node());
    ((DeclarationNode*)parameter)->type_specifier = create_value_node("float");
    params[0] = parameter;
...
START_TEST(test_array_declaration)
{
    ...
    Node* root = create_declaration_node(array, create_empty_statement_node());
    ((DeclarationNode*)root)->type_specifier = create_value_node("float");
...
START_TEST(test_multidimensional_array_declaration)
{
    ...
    Node* root = create_declaration_node(dim2, create_empty_statement_node());
    ((DeclarationNode*)root)->type_specifier = create_value_node("int");
