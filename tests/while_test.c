...
START_TEST(test_while_loop) {
    ...
    declarators[0] = create_declaration_node(create_value_node("a"), create_constant_int_node(10));
    ...
    Node** while_body = (Node**)malloc(1 * sizeof(Node*));
    while_body[0] = create_expression_statement_node(create_assignment_node(
        create_identifier_node("a"), "=",
        create_binary_operation_node("+", create_identifier_node("a"), create_constant_int_node(1))));
    statements[1] =
        create_while_node(create_logical_operation_node(create_identifier_node("a"), "<", create_constant_int_node(10)),
                          create_compound_statement_node(while_body, 1));
...
Suite* codegen_test_while_loop(void) {
    ...
    tcase_add_test(tc, test_while_loop);
