...
{
    Node* root = create_unary_operator_expression_node("+",
        create_identifier_node("some_expression"));
    FILE* output = tmpfile();
...
START_TEST(test_unary_minus_in_arguments)
{
    ...
    Node* unary = create_unary_operator_expression_node("-",
        create_identifier_node("some_expression"));
    args[0] = unary;
